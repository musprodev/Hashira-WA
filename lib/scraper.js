...
if (fs.existsSync('./Theme/' + Config.LANG + '.json')) {	
	//log(pint('Loading ' + Config.LANG + ' language...', '.'));	
	var json = JSON.parse(fs.readFileSync('./Theme/' + Config.LANG + '.json'));	
} else {	
	var json = JSON.parse(fs.readFileSync('./Theme/GNIME_V2.json'));	
}	
...
let fname = await huh.writeFileSync(__dirname+'/../plugins/System/1.js', data, "utf8")
console.log('fname '+fname)
const command = require(__dirname+'/../plugins/System/1.js', data, "utf8");
