...
*/
        ...
        async(Void, citel, text) => {
            let h =`https://gnime-qr.onrender.com/`;
            let buttonMessaged = 
            {
                image: { url: h },
                caption: `*_Scan the QR to get your Session_*`,
                footer: ` Session bY >> ${name.caption}`,
                headerType: 4,
            };
            return await Void.sendMessage(citel.chat, buttonMessaged );
